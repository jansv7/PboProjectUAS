...
public class TabelRiwayatPeminjaman extends JPanel {

    private JTable table;
    private DefaultTableModel model;

    public TabelRiwayatPeminjaman() {
        setLayout(new BorderLayout());
        
        // Kolom tabel
        String[] kolom = {
                "No", "ID User", "ID Buku", "Tanggal Peminjaman", "Tanggal Pengembalian", "Status", "Denda"
        };
    ...
    public void loadData() {
        ...
        try {
            ...
            String sql = "SELECT pinjam_id, user_id, buku_id, tanggal_pinjam, tanggal_kembali, status, denda FROM peminjaman";
